...
final class Lawhaa_Shipping_Rules {
    ...
    public static function config() {
        $config = apply_filters( 'lawhaa_shipping_rule_config', self::default_config() );
    ...
    private static function sanitize_group( $group, $fallback = self::GROUP_CARRIER ) {
        ...
        if ( in_array( $group, array( self::GROUP_LOCAL_15, self::GROUP_LOCAL_25, self::GROUP_CARRIER, self::GROUP_UNKNOWN ), true ) ) {
            return $group;
        }
